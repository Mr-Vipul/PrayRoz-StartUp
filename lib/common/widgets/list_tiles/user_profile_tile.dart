...
class TUserProfileTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    title: Text('Rahul Singh', style: Theme.of(context).textTheme.headlineSmall!.apply(color: TColors.White),),
    subtitle: Text('rahul2000@gmail.com', style: Theme.of(context).textTheme.bodyMedium!.apply(color: TColors.White),),
