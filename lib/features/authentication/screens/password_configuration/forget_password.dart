...
import 'package:prayroz/features/authentication/screens/password_configuration/reset_password.dart';
    ...
    return Scaffold(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox (height: TSizes.spaceBtwSections), // TextFormField
